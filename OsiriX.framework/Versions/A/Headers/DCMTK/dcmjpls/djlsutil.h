...
#define DCMJPLS_TRACE(msg) printf( msg);
#define DCMJPLS_DEBUG(msg) printf( msg);
#define DCMJPLS_INFO(msg)  printf( msg);
#define DCMJPLS_WARN(msg)  printf( msg);
#define DCMJPLS_ERROR(msg) printf( msg);
#define DCMJPLS_FATAL(msg) printf( msg);
